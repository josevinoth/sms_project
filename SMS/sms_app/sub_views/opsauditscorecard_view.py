...
def opsauditscorecard_add(request, ops_audit_id=0):
    ...
    categories = {
        ...
        "Compliance": {"fields": ["ops_S_E_registration", "ops_CLRA_certification", "ops_insurance_policy_validity",
                                  "ops_Customer_Contract_validity","ops_Vendor_Contract_validity","ops_Customer_code_process_followed","ops_Asset_Audit_done"], "expected_score": 7},
        "Customer": {"fields": ["ops_incident_accident_reporting", "ops_monthly_reviews_done","ops_KPI_achieved"], "expected_score": 3},
        ...
        "Process": {"fields": ["ops_vehicle_inward_register", "ops_truck_validation", "ops_driver_validation",
                               ...
                               "ops_3_or_7_days_cargo_report_mail",
                               "ops_dispatch_process", "ops_receive_print_tally_airline_labels",
                               "ops_double_check_dispatch",
                               "ops_OTL_check", "ops_gate_Pass", "ops_outward_dispatch_register",
                               "ops_seal_integrity_prior_unsealing_unloading",
                               "ops_stacking","ops_gate_meeting_conducted_daily"], "expected_score": 20},
        "Reports": {"fields": ["ops_BRP_Management_Reports", "ops_daily_weekly_physical_stock_report"],
                    "expected_score": 2},
        "Safety": {
        ...
        "WMS Usage": {"fields": ["ops_timely_complete_data_entry", "ops_All_masters_updation",
                                 ], "expected_score": 2},
    }
...
def send_ops_audit_email(request):
    ...
    categories = {
        ...
        "CCTV": {"fields": [
            ...
            "ops_CCTV_record_availability_30_days", "ops_CCTV_storage_data_90_days"], "expected_score": 12},
        "Compliance": {"fields": ["ops_S_E_registration", "ops_CLRA_certification", "ops_insurance_policy_validity",
                                  "ops_Customer_Contract_validity", "ops_Vendor_Contract_validity",
                                  "ops_Customer_code_process_followed", "ops_Asset_Audit_done"], "expected_score": 7},
        "Customer": {"fields": ["ops_incident_accident_reporting", "ops_monthly_reviews_done", "ops_KPI_achieved"],
                     "expected_score": 3},
        "Facility": {"fields": ["ops_entry_ways_clean", "ops_facility_exterior_interior_scrap",
                                "ops_exterior_walls_clean_cracks",
                                "ops_No_broken_windows_glass", "ops_all_dock_good_working_condition",
