...
def send_ops_audit_email(request):
    ...
    categories = {
        ...
        "Compliance": {"fields": ["ops_S_E_registration", "ops_CLRA_certification", "ops_insurance_policy_validity",
                                  "ops_Contract_validity"], "expected_score": 4},
        "Customer": {"fields": ["ops_incident_accident_reporting", "ops_monthly_reviews_done"], "expected_score": 2},
        "Facility": {"fields": ["ops_entry_ways_clean", "ops_facility_exterior_interior_scrap", "ops_exterior_walls_clean_cracks",
                                "ops_No_broken_windows_glass", "ops_all_dock_good_working_condition",
                                "ops_adequate_lights_loading_unloading", "ops_adequate_lights_CCTV_coverage",
                                "ops_dock_leveller_used_sheets_used", "ops_warehouse_cleanliness",
                                "ops_open_carton_boxes_items", "ops_dumping_cargo"], "expected_score": 11},
        "Finance": {"fields": ["ops_timely_accurate_billing"], "expected_score": 1},
        "HR": {"fields": ["ops_staff_attendance", "ops_working_hours_information_board",
                          "ops_employees_wearing_company_issued_badges", "ops_manpower_contract"], "expected_score": 4},
        "Process": {"fields": ["ops_vehicle_inward_register", "ops_truck_validation", "ops_driver_validation",
                               "ops_document_validation", "ops_shipment_validation", "ops_check_OSD_packages",
                               "ops_driver_ACk_copy", "ops_shipment_weighment_process", "ops_shipment_dimensions_process",
                               "ops_cargo_storage_stacking_SOP", "ops_more_than_3_days_cargo_report_mail",
                               "ops_dispatch_process", "ops_receive_print_tally_airline_labels",
                               "ops_double_check_shipments", "ops_Truck_validation", "ops_Driver_validation",
                               "ops_Document_validation", "ops_check_OSD_Packages", "ops_OTL_process",
                               "ops_gate_Pass", "ops_outward_dispatch_register",
                               "ops_seal_integrity_prior_unsealing_unloading", "ops_stacking"], "expected_score": 23},
        "Reports": {"fields": ["ops_daily_stock_register", "ops_daily_weekly_physical_stock_report"], "expected_score": 2},
        "Safety": {"fields": ["ops_are_handlers_wearing_reflective_vests", "ops_are_loaders_handlers_wearing_safety_shoes",
                              "ops_are_fire_extinguishers_present_validity", "ops_fire_extinguishers_access_clear_without_hindrance",
                              "ops_fire_alarm_system_working_condition", "ops_first_aid_box", "ops_DG_cargo"], "expected_score": 7},
        "Security": {"fields": ["ops_warehouse_key_register", "ops_facility_opening_checklist", "ops_high_value_cargo",
                                "ops_seal_inventory_usage_records", "ops_warehouse_office_key_control",
                                "ops_authorized_personnel_display_available", "ops_checklist_facility_closing",
                                "ops_intrusion_alarm_systems_availability", "ops_emergency_contact_names_numbers_display",
                                "ops_each_employee_alarm_code_password_unique", "ops_daily_trash_checklist",
                                "ops_key_index_form", "ops_no_of_security_available_contract",
                                "ops_whether_continuous_shift_not", "ops_last_30_days_CCTV_check_random_absence_sleeping",
                                "ops_registers_maintained_properly_not", "ops_security_attire", "ops_supervisor_visit",
                                "ops_night_visit_check", "ops_night_hourly_pictures_captured_CCTV",
                                "ops_seal_inventory_proper_maintenance_storage"], "expected_score": 21},
        "Systems": {"fields": ["ops_are_systems_unique_and_password_protected", "ops_unused_systems_equipment",
                               "ops_condition_system_keeping_maintenance", "ops_AMC_systems",
                               "ops_to_check_inspection_report_system_maintenance"], "expected_score": 5},
        "Visitors": {"fields": ["ops_visitor_log", "ops_visitor_badges_are_present_log"], "expected_score": 2},
        "WMS Usage": {"fields": ["ops_timely_complete_data_entry", "ops_rate_updation_contract_updation",
                                 "ops_reports_including_DSR_correctness"], "expected_score": 3},
    }
    ...
    for entry in distinct_audit_entries:
        ...
        <html>
            <head>
                <style>
                    table {{ width: 80%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 14px; border: 1px solid black; margin-top: 10px; }}
                    th, td {{ border: 1px solid black; padding: 8px; text-align: left; }}
                    th {{ background-color: #dff0d8; color: #333; }}
                </style>
            </head>
            <body>
                <p>Dear Team,</p>
                <p>Please find below the Ops Audit Scorecard details for {branch} - {unit} on {date}:</p>
                <table>
                ...
                <table>
                    <tr><th>Overall Score</th><td>{overall_total_yes} / {overall_expected_count}</td></tr>
                </table>
