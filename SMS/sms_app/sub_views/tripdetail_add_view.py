...
def trip_send_loading_report_mail(request):
    ...
    subject = f"Trip Loading Reported - {trip.tr_tripnumber or ''}"
...
def trip_send_trip_started_mail(request):
    ...
    subject = f"Trip Started - {trip.tr_tripnumber}"
...
def trip_send_unloading_report_mail(request):
    ...
    subject = f"Trip Unloading Reported - {trip.tr_tripnumber}"
        ...
        <table style="border-collapse: collapse; width: 100%; border: 1px solid #ddd; font-family: Arial, sans-serif;">
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;"><b>Vehicle Reported Date & Time (Loading)</b></td>
                    <td style="padding: 8px; border: 1px solid #ddd;">{loading_reported_dt}</td>
                </tr>
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;"><b>Consignment Number</b></td>
                    <td style="padding: 8px; border: 1px solid #ddd;">{consignment}</td>
...
def trip_send_trip_closed_mail(request):
    ...
    subject = f"Trip Closed - {trip.tr_tripnumber}"
    ...
    <body>
        ...
        <table style="border-collapse: collapse; width: 100%; border: 1px solid #ddd; font-family: Arial, sans-serif;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;"><b>Trip Number</b></td>
                    <td style="padding: 8px; border: 1px solid #ddd;">{trip.tr_tripnumber}</td>
                </tr>
                <tr>
                    <td style="padding: 8px; border: 1px solid #ddd;"><b>Status</b></td>
                    <td style="padding: 8px; border: 1px solid #ddd;">Trip Closed</td>
                </tr>
            </tbody>
        </table>
        <p>Regards,<br>BVM Warehouse Team</p>
