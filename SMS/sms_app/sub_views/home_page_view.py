...
def home_page(request):
    ...
    manager_listcount =MaintenanceInfo.objects.filter(mi_approval_status=1).count()
    finance_listcount =MaintenanceInfo.objects.filter(mi_approval_status=2).count()
