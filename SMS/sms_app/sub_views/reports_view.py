...
def export_stockreport_to_csv(request):
    ...
    data = Warehouse_goods_info.objects.filter(
        ...
        'wh_job_no', 'wh_qr_rand_num', 'wh_customer_name',
        ...
        'wh_consigner', 'wh_consignee', 'wh_lb_job_no_id__lb_packing_list',
        ...
        'wh_goods_package_type', 'wh_chargeable_weight', 'wh_cbm', 'wh_invoice_value',
        'wh_lb_job_no_id__lb_stock_invoice_currency', 'wh_invoice_amount_inr',
        'wh_lb_job_no_id__lb_eway_bill',
        Func('eway_bill_validity', Value('YYYY-MM-DD HH24:MI:SS'), function='to_char', output_field=CharField()),
        'wh_fumigation_process', 'wh_check_in_out', 'wh_branch', 'wh_unit',
        'wh_bay', 'wh_storage_time', 'wh_dispatch_id__dispatch_truck_number',
        'wh_dispatch_id__dispatch_truck_type',
        Func('departure_time', Value('YYYY-MM-DD HH24:MI:SS'), function='to_char', output_field=CharField()),
        'wh_dispatch_id__dispatch_sticker_pasted_bvm', 'wh_dispatch_id__dispatch_mawb',
