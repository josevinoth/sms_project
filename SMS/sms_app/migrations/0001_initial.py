# Generated by Django 4.2.9 on 2024-09-19 12:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='t_updated_by',
            field=models.ForeignKey(db_column='t_updated_by', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='t_updated_by', to='sms_app.myuser'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s_joint_call_name', models.ManyToManyField(to='sms_app.myuser')),
        ...
        migrations.AddField(
            model_name='requirementsinfo',
            name='req_implementedby',
            field=models.ForeignKey(blank=True, db_column='req_implementedby', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='req_implementedby', to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='requirementsinfo',
            name='req_module',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.reqmodule'),
        ),
        migrations.AddField(
            model_name='requirementsinfo',
            name='req_owner',
            field=models.ForeignKey(db_column='req_owner', default='', on_delete=django.db.models.deletion.CASCADE, related_name='req_owner', to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='requirementsinfo',
            name='req_status',
            field=models.ForeignKey(default=2, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.statuslist'),
        ),
        migrations.AddField(
            model_name='requirementsinfo',
            name='req_updated_by',
        ...
        migrations.AddField(
            model_name='pkpurchaseorderinfo',
            name='po_quotation_num',
            field=models.ForeignKey(db_column='po_quotation_num', on_delete=django.db.models.deletion.CASCADE, related_name='po_quotation_num', to='sms_app.pkquotationsummaryinfo'),
        ),
        migrations.AddField(
            model_name='pkpurchaseorderinfo',
            name='po_status',
            field=models.ForeignKey(blank=True, db_column='po_status', default=6, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='po_status', to='sms_app.statuslist'),
        ),
        migrations.AddField(
            model_name='pkpurchaseorderinfo',
            name='po_updated_by',
            field=models.ForeignKey(db_column='po_updated_by', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='po_updated_by', to='sms_app.myuser'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_customer_name',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerinfo'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_delivery_by',
            field=models.ForeignKey(blank=True, db_column='na_delivery_by', default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='na_delivery_by', to='sms_app.nabvmcustomer'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_delivery_type',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.nadeliverytype'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_packing_field',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.napackingfield'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_special_requirements',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.naspecialrequirements'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_status',
            field=models.ForeignKey(blank=True, default=6, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.statuslist'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_type_of_access',
            field=models.ManyToManyField(to='sms_app.natypeofaccess'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_type_of_pack',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.natypeofpack'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_type_of_work',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.natypeofwork'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_unloading',
            field=models.ForeignKey(db_column='na_unloading', default='', on_delete=django.db.models.deletion.CASCADE, related_name='na_unloading', to='sms_app.nabvmcustomer'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_updated_by',
        ...
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_wood_norms',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.nawoodnorms'),
        ),
        migrations.AddField(
            model_name='pkneedassessmentinfo',
            name='na_wood_treatment_req',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.nawoodtreatmentreq'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='pk_itemdescriptioninfo',
            name='id_item_name',
            field=models.ForeignKey(db_column='id_item_name', on_delete=django.db.models.deletion.CASCADE, related_name='id_item_name', to='sms_app.pk_iteminfo'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_assess_num',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.pkneedassessmentinfo'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_dimension_type',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.nadimensiontype'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_type_of_req',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms_app.natypeofreq'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_uom',
            field=models.ForeignKey(blank=True, default='', limit_choices_to={'id__in': [1, 2, 3, 4]}, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.unitofmeasure'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_updated_by',
            field=models.ForeignKey(db_column='nad_updated_by', on_delete=django.db.models.deletion.CASCADE, related_name='nad_updated_by', to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_wood_description',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.stockdescription'),
        ),
        migrations.AddField(
            model_name='nadimension',
            name='nad_wood_type',
            field=models.ForeignKey(limit_choices_to={'id__in': [1, 4]}, on_delete=django.db.models.deletion.CASCADE, to='sms_app.pkstocktype'),
        ),
        migrations.CreateModel(
            name='ml_Product',
            fields=[
        ...
        migrations.AddField(
            model_name='loadingbay_info',
            name='lb_pouch_yes',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.sealedoropenedinfo'),
        ),
        migrations.AddField(
            model_name='loadingbay_info',
            name='lb_status',
            field=models.ForeignKey(default=6, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.statuslist'),
        ),
        migrations.AddField(
            model_name='loadingbay_info',
            name='lb_stock_invoice_currency',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.currency_type'),
        ),
        migrations.AddField(
            model_name='iou_info',
            name='iou_updated_by',
            field=models.ForeignKey(blank=True, db_column='iou_updated_by', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='iou_updated_by', to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='iou_info',
            name='staff_id',
            field=models.ForeignKey(db_column='staff_id', on_delete=django.db.models.deletion.CASCADE, related_name='staff_id', to=settings.AUTH_USER_MODEL, to_field='username'),
        ),
        migrations.AddField(
            model_name='iou_info',
            name='transaction_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms_app.expensecategoryinfo'),
        ),
        migrations.CreateModel(
            name='Insurance_Info',
            fields=[
                ...
                ('ins_branch', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.location_info')),
                ...
                ('ins_updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.myuser')),
        ...
        migrations.AddField(
            ...
            name='gatein_pre_branch',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.location_info'),
        ),
        migrations.AddField(
            model_name='gatein_pre_info',
            name='gatein_pre_status',
            field=models.ForeignKey(default=6, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.statuslist'),
        ),
        migrations.AddField(
            model_name='gatein_pre_info',
            name='gatein_pre_updated_by',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_comodity',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.stock_type'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerinfo'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_customer_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms_app.trbusinesstypeinfo'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_department',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerdepartmentinfo'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_job_status',
            field=models.ForeignKey(default=2, on_delete=django.db.models.deletion.CASCADE, to='sms_app.gstexcemptioninfo'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_pre_id',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.gatein_pre_info'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_status',
        ...
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_truck_number_n',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms_app.pregateintruckinfo'),
        ),
        migrations.AddField(
            model_name='gatein_info',
            name='gatein_updated_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.myuser'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exp_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.unitinfo')),
        ...
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_business_type',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.tr_businesstype_info'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_customerdepartment',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerdepartmentinfo'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_customername',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerinfo'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_fromlocaion',
            field=models.ForeignKey(blank=True, db_column='en_fromlocaion', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='en_fromlocaion', to='sms_app.places'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_movement_type',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.movementtypeinfo'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_status',
        ...
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_tolocation',
            field=models.ForeignKey(blank=True, db_column='en_tolocation', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='en_tolocation', to='sms_app.places'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_touchpoint',
            field=models.ForeignKey(blank=True, db_column='en_touchpoint', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='en_touchpoint', to='sms_app.places'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_touchpoint2',
            field=models.ForeignKey(blank=True, db_column='en_touchpoint2', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='en_touchpoint2', to='sms_app.places'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_touchpoint3',
            field=models.ForeignKey(blank=True, db_column='en_touchpoint3', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='en_touchpoint3', to='sms_app.places'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_touchpoint4',
            field=models.ForeignKey(blank=True, db_column='en_touchpoint4', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='en_touchpoint4', to='sms_app.places'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_trip_type',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.tr_triptype_info'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_updated_by',
        ...
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_vehiclecategory',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.vehiclecategoryinfo'),
        ),
        migrations.AddField(
            model_name='enquirynoteinfo',
            name='en_vehicletype',
        ...
        migrations.AddField(
            ...
            name='dispatch_cargo_picked',
            field=models.ForeignKey(db_column='dispatch_cargo_picked', on_delete=django.db.models.deletion.CASCADE, related_name='dispatch_cargo_picked', to='sms_app.gstexcemptioninfo'),
        ),
        migrations.AddField(
            model_name='dispatch_info',
            name='dispatch_customer',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerinfo'),
        ),
        migrations.AddField(
            model_name='dispatch_info',
        ...
        migrations.AddField(
            model_name='dispatch_info',
            name='dispatch_sticker_pasted_bvm',
            field=models.ForeignKey(blank=True, db_column='dispatch_sticker_pasted_bvm', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dispatch_sticker_pasted_bvm', to='sms_app.labels_pasted_info'),
        ),
        migrations.AddField(
            model_name='dispatch_info',
            name='dispatch_truck_type',
            field=models.ForeignKey(db_column='dispatch_truck_type', default='', on_delete=django.db.models.deletion.CASCADE, related_name='dispatch_truck_type', to='sms_app.vehicletypeinfo'),
        ),
        migrations.AddField(
            model_name='dispatch_info',
            name='dispatch_truck_type_billing',
            field=models.ForeignKey(blank=True, db_column='dispatch_truck_type_billing', default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dispatch_truck_type_billing', to='sms_app.vehicletypeinfo'),
        ),
        migrations.AddField(
            model_name='dispatch_info',
            name='dispatch_updated_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='damagereportinfo',
            name='dam_marks_numbers',
            field=models.ForeignKey(db_column='dam_marks_numbers', default=2, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dam_marks_numbers', to='sms_app.gstexcemptioninfo'),
        ),
        migrations.AddField(
            model_name='damagereportinfo',
            name='dam_no_of_units_deviation',
            field=models.ForeignKey(db_column='dam_no_of_units_deviation', default=2, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dam_no_of_units_deviation', to='sms_app.gstexcemptioninfo'),
        ),
        migrations.AddField(
            model_name='damagereportinfo',
            name='dam_ratification_process',
            field=models.ForeignKey(db_column='dam_ratification_process', default=2, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dam_ratification_process', to='sms_app.gstexcemptioninfo'),
        ),
        migrations.AddField(
            model_name='damagereportinfo',
            name='dam_status',
        ...
        migrations.AddField(
            ...
            name='cu_businessmodel',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.trbusinesstypeinfo'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_creditcountfrom',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.crcountfrominfo'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_gstexcepmtion',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.gstexcemptioninfo'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_gstmodel',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.gstmodelinfo'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_industry_type',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.industrytype'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_lastmodifiedby',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_paymentcycle',
            field=models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.paymentcycleinfo'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_paymenttype',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.paymenttypeinfo'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='cu_type',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.customertypeinfo'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='co_customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.customerinfo'),
        ),
        migrations.AddField(
            model_name='consignmentdetailinfo',
            name='co_enquirynumber',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.enquirynoteinfo'),
        ),
        migrations.AddField(
            model_name='consignmentdetailinfo',
            name='co_gst_payable_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.gst_payable_info'),
        ),
        migrations.AddField(
            model_name='consignmentdetailinfo',
            name='co_lastmodifiedby',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sms_app.myuser'),
        ),
        migrations.AddField(
            model_name='consignmentdetailinfo',
            name='co_status',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.statuslist'),
        ),
        migrations.CreateModel(
            name='commentsInfo',
            fields=[
        ...
        migrations.AddField(
            model_name='bunkname',
            name='bunk_fuel_vendor',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='sms_app.fuelvendor'),
        ),
        migrations.CreateModel(
            name='BilingInfo',
            fields=[
