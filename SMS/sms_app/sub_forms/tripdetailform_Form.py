...
class TripdetailaddForm(forms.ModelForm):
    ...
    class Meta:
        ...
        # fields = '__all__'
        fields = ['tr_enquirynumber', 'tr_consignmentnumber', 'tr_tripnumber', 'tr_vehiclesource', 'tr_vehicletype',
                  'tr_vehicletype_placed', 'tr_vehicletype_selection_requested', 'tr_vehicletype_selection_placed',
