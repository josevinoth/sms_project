...
class HighvalueForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['hc_storage_cross_docking_labelling'].empty_label = "--Select--"
        self.fields['hc_mhe_required_handle'].empty_label = "--Select--"
        ...
        self.fields['hc_unit_of_measure'].empty_label = "--Select--"
