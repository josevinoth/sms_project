...
class Gatein_preaddForm(forms.ModelForm):
    class Meta:
        ...
        # fields = '__all__'
        fields = ['gatein_pre_number','gatein_pre_transporter','gatein_pre_truck_number','gatein_pre_truck_type','gatein_pre_driver','gatein_pre_contact_number','gatein_pre_DL_number','gatein_pre_arrival_date_time','gatein_pre_otl','gatein_pre_status']
