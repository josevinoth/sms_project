...
urlpatterns = [
    ...
    path('stock_description_add', views.stock_description_add, name='stock_description_add'),
    path('stock_description_add/<int:sd_id>/', views.stock_description_add, name='stock_description_update'),
    path('stock_description_delete/<int:sd_id>/', views.stock_description_delete, name='stock_description_delete'),
    path('stock_description_search', views.stock_description_search, name='stock_description_search'),
    ...
    path('pk_production_return_edit/<str:job_no>/', views.pk_production_return_edit, name='pk_production_return_edit'),
    ...
    path('get_ledger_balance/', views.get_ledger_balance, name='get_ledger_balance'),
    path('wms_petty_cash_list/', views.wms_petty_cash_list, name='wms_petty_cash_list'),
    path('wms_petty_cash_insert/', views.wms_petty_cash_add, name='wms_petty_cash_insert'),
    ...
    path('cs_kpi_dashboard/', views.cs_kpi_dashboard, name='cs_kpi_dashboard'),
    path('get_cs_kpi_dashboard_data/', views.get_cs_kpi_dashboard_data, name='get_cs_kpi_dashboard_data'),
    path('customer_claims_report/', views.customer_claims_report, name='customer_claims_report'),
    ...
    path('trip_report_ajax/', views.trip_report_ajax, name='trip_report_ajax'),
    ...
    path('trip_settlement_list_ajax/', views.trip_settlement_list_ajax_view, name='trip_settlement_list_ajax'),
    ...
    path('driver_salary_insert/', views.driver_salary_add, name='driver_salary_insert'),
    path('driver_salary_update/<int:salary_id>/', views.driver_salary_add, name='driver_salary_update'),
    path('driver_salary_delete/<int:salary_id>/', views.driver_salary_delete, name='driver_salary_delete'),
    path('ajax/get-driver-salary-details/', views.get_driver_salary_details, name='get_driver_salary_details'),
    ...
    path('ajax/search-customers-select2/', views.ajax_search_customers_select2, name='ajax_search_customers_select2'),
    path('ajax/search-places-select2/', views.ajax_search_places_select2, name='ajax_search_places_select2'),
    ...
    path('vehicle_log_report_ajax/', views.vehicle_log_report_ajax_view, name='vehicle_log_report_ajax'),
    ...
    path('trip_status_count_report/', views.trip_status_count_report_view, name='trip_status_count_report'),
    path('trip_status_count_report_ajax/', views.trip_status_count_report_ajax_view, name='trip_status_count_report_ajax'),
    ...
    path('vendor_bills_pending_mkt_att_report_ajax/', views.vendor_bills_pending_mkt_att_report_ajax_view, name='vendor_bills_pending_mkt_att_report_ajax'),
    ...
    path('attached_bill/export_tally/', views.attached_bill_export_tally, name='attached_bill_export_tally'),
