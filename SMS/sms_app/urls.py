...
urlpatterns = [
    ...
    path('costing_summary_check_unique_field/', views.costing_summary_check_unique_field, name='costing_summary_check_unique_field'),  # costing_summary_check_unique_field
    ...
    path('update_dipsatch_id/', views.update_dipsatch_id, name='update_dipsatch_id'),# dispatch_stock_list
]
