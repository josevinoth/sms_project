...
urlpatterns = [
    ...
    path('loadingbay_update_new/<int:loadingbay_id>/', views.loadingbay_add_new, name='loadingbay_update_new'),  # loadingbay update
    path('loadingbay_insert_new', views.loadingbay_add_new, name='loadingbay_insert_new'),  # loadingbay insert
    path('load_currency_value/', views.load_currency_value, name='load_currency_value'), #Load currency coversion value
    path('load_currency_value_new/', views.load_currency_value_new, name='load_currency_value_new'), #Load currency coversion value
