...
urlpatterns = [
    ...
    path('quote_list/', views.quote_list, name='quote_list'),  # List quote
    path('quote_insert/', views.quote_add, name='quote_insert'),  # Add quote
    path('quote_update/<int:quote_id>', views.quote_add, name='quote_update'),# update quote
    path('quote_delete/<int:quote_id>', views.quote_delete, name='quote_delete'),# delete quote
