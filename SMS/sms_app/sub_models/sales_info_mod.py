...
class SalesInfo(models.Model):
    ...
    s_customer_prospective = models.ForeignKey(YesNoInfo,blank=True, null=True, on_delete=models.CASCADE, related_name='s_customer_prospective', db_column='s_customer_prospective',default='')
    s_noreason_cp = models.ForeignKey(Prespectivec_customer_NoInfo,blank=True, null=True, on_delete=models.CASCADE)
    s_yesdate_quote = models.DateField(null = True,blank=True)
    s_quote_ref = models.CharField(blank=True, null=True,max_length=30)
    s_bus_won_not = models.ForeignKey(YesNoInfo,blank=True, null=True, on_delete=models.CASCADE,related_name='s_bus_won_not', db_column='s_bus_won_not', default='')
    s_not_reason = models.ForeignKey(Business_won_NoInfo,blank=True, null=True, on_delete=models.CASCADE)
    s_yesdate_business = models.DateField(null = True,blank=True)
    s_kyc = models.ForeignKey(YesNoInfo,blank=True, null=True, on_delete=models.CASCADE,related_name='s_kyc', db_column='s_kyc' ,default='')
    s_contract = models.ForeignKey(YesNoInfo,blank=True, null=True, on_delete=models.CASCADE,related_name='s_contract', db_column='s_contract', default='')
    ...
    s_approver_name = models.CharField(blank=True, null=True,max_length=30)
