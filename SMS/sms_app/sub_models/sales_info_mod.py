...
class SalesInfo(models.Model):
    s_customer_name = models.ForeignKey(CustomerInfo, on_delete=models.CASCADE,default='')
    ...
    s_location = models.ForeignKey(Location_info,blank=True, null=True, on_delete=models.CASCADE, default=2)
    ...
    s_email_id = models.EmailField(max_length=100,blank=True,null=True)
    s_decision_maker = models.ForeignKey(YesNoInfo, on_delete=models.CASCADE,related_name='s_decision_maker', db_column='s_decision_maker',blank=True,null=True)
    s_name_dm = models.CharField(max_length=100,blank=True,null=True)
    s_designation_dm = models.CharField(max_length=100,blank=True,null=True)
    s_emailid_dm = models.EmailField(max_length=100,blank=True,null=True)
