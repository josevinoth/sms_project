...
class SalesInfo(models.Model):
    ...
    s_name_dm = models.CharField(blank=True, null=True,max_length=30)
    s_designation_dm = models.CharField(blank=True, null=True,max_length=30)
    ...
    s_rate_approval = models.ForeignKey(MyUser, blank=True, null=True,on_delete=models.CASCADE,related_name='s_rate_approval', db_column='s_rate_approval', default='')
