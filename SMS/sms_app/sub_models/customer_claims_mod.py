...
class CustomerClaimsInfo(models.Model):
    ...
    cc_CAPA_issueddate = models.DateField(null=True, blank=True)
    cc_CAPA_closeddate = models.DateField(null=True, blank=True)
    ...
    cc_amount = models.FloatField(default=0.0)