...
class EnquirynoteInfo(models.Model):
    ...
    en_customerdepartment = models.ForeignKey(CustomerdepartmentInfo, on_delete=models.CASCADE, default='', null=True, blank=True)
    ...
    en_contactno = models.CharField(max_length=10, default='', null=True, blank=True)
    en_email = models.EmailField(max_length=50, default='', null=True, blank=True)
    ...
    en_no_of_vehicles = models.IntegerField(default=0, blank=True)
    en_no_of_pcs = models.IntegerField(default=0, blank=True)
