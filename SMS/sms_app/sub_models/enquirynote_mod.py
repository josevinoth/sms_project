...
class EnquirynoteInfo(models.Model):
    ...
    en_touchpoint= models.ForeignKey(City,on_delete=models.CASCADE,related_name='en_touchpoint', db_column='en_touchpoint',null=True,blank=True)
    ...
    en_trip_type = models.ForeignKey(Tr_triptype_Info, on_delete=models.CASCADE, default=1,null=True,blank=True)
    def __str__(self):
