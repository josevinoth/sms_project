...
from ..models import Packagetype_info,StatusList,DamageInfo,Location_info,UnitInfo,BayInfo
...
class Warehouse_goods_info(models.Model):
    ...
    wh_check_in_out= models.ForeignKey(StatusList, on_delete=models.CASCADE, null=True, related_name='wh_check_in_out',db_column='wh_check_in_out')
