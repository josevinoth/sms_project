...
class Dispatch_info(models.Model):
    ...
    dispatch_transporter = models.CharField(null=False, max_length=50)
    ...
    dispatch_HAWB = models.CharField(null=True, max_length=30)
    dispatch_MAWB = models.CharField(null=True, max_length=30)
