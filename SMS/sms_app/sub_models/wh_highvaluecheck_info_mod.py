...
class HighvalueInfo(models.Model):
    hc_location = models.ForeignKey(Location_info, on_delete=models.CASCADE, default='')
    hc_unit_reference = models.ForeignKey(UnitInfo, on_delete=models.CASCADE, default='')
    hc_date = models.CharField(max_length=50)
    hc_customer = models.ForeignKey(CustomerInfo, on_delete=models.CASCADE)
    hc_shipper = models.CharField(max_length=50)
    hc_customer_reference_number = models.CharField(max_length=50)
    hc_invoice_ref = models.CharField(max_length=50)
    hc_commodity = models.ForeignKey(Stock_type, on_delete=models.CASCADE)
    ...
    hc_storage_location = models.CharField(max_length=50)
    ...
    hc_bvm_scope_work = models.TextField(max_length=50)
    hc_weight = models.FloatField(  default=0.0)
    hc_dimension = models.FloatField(  default=0.0)
