...
class HighvalueInfo(models.Model):
    ...
    hc_condition_cargo_received = models.ForeignKey(DamageInfo, null=True,on_delete=models.CASCADE, default='')
    ...
    hc_storage_cross_docking_labelling = models.ForeignKey(storagecrosslabelInfo,blank=True, null=True,on_delete=models.CASCADE)
    ...
    hc_mhe_required_handle = models.ForeignKey(hptforkliftcraneInfo,blank=True, null=True,on_delete=models.CASCADE)
    hc_unit_of_measure = models.ForeignKey(Unitofmeasure,blank=True, null=True,on_delete=models.CASCADE)
    def __str__(self):
