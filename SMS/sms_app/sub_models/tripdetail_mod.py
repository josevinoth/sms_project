...
class TripdetailInfo(models.Model):
    ...
    tr_departedlocation = models.ForeignKey(City,on_delete=models.CASCADE,related_name='tr_departedlocation', db_column='tr_departedlocation')
    tr_departedkm = models.IntegerField(default='')
    tr_departeddate = models.DateTimeField(null=True, blank=True)
    tr_reportedlocation = models.ForeignKey(City,on_delete=models.CASCADE,related_name='tr_reportedlocation', db_column='tr_reportedlocation')
