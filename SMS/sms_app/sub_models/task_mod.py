...
class task_Info(models.Model):
    application = models.ForeignKey(applicaiton_Info,on_delete=models.CASCADE, related_name='application',db_column='application',default=2)
    main_task = models.TextField(max_length=1000)
    sub_task = models.TextField(max_length=1000)
