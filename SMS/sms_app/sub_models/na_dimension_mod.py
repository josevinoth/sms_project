...
class Nadimension(models.Model):
    ...
    nad_wood_description = models.ForeignKey(Stockdescription, on_delete=models.CASCADE, default='')
    nad_job_weight = models.FloatField( default=0.0)
    nad_type_of_req = models.ForeignKey(Natypeofreq, on_delete=models.CASCADE)
    nad_uom = models.ForeignKey(Unitofmeasure, on_delete=models.CASCADE, default='', limit_choices_to={'id__in': [1,2,3,4]})
