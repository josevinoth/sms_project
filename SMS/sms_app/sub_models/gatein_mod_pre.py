...
class Gatein_pre_info(models.Model):
    ...
    gatein_pre_transporter = models.CharField(blank=True, null=True, max_length=1000)
    gatein_pre_truck_number = models.CharField(blank=True, null=True, max_length=200)
    ...
    gatein_pre_driver = models.CharField(blank=True, null=True, max_length=500)
    gatein_pre_contact_number = models.CharField(blank=True, null=True, max_length=500)
    gatein_pre_DL_number = models.CharField(blank=True, null=True, max_length=500)
