...
from ..models import MyUser,StatusList,VehicletypeInfo,CustomernameInfo_new
...
class Gatein_info(models.Model):
    ...
    gatein_customer = models.CharField(blank=True, null=True, max_length=20)
    gatein_customer_type = models.CharField(blank=True, null=True, max_length=20)
