...
class Gatein_info(models.Model):
    ...
    gatein_truck_type = models.CharField(blank=True, null=True, max_length=2000)
    ...
    gatein_truck_number_n = models.ForeignKey(Pregateintruckinfo, on_delete=models.CASCADE, blank=False, null=False)
    ...
    gatein_so_number = models.CharField(max_length=50, blank=True, null=True)
    class Meta:
