...
from ..models import PkpurchaseorderInfo,CustomerInfo,POdimension,pk_stock_statusinfo,pk_itemdescriptionInfo,pk_itemInfo,PkstockpurchasesInfo,Pkstocktype,MyUser,Costtype,Stockdescription,Unitofmeasure,PkneedassessmentInfo
...
class PkcostingInfo(models.Model):
    ...
    ct_requirement=models.ForeignKey(POdimension, on_delete=models.CASCADE,blank=True,null=True,related_name='ct_requirement', db_column='ct_requirement',)
