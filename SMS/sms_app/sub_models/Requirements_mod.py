...
class RequirementsInfo(models.Model):
    ...
    req_module = models.ForeignKey(Reqmodule, on_delete=models.CASCADE, default=1)
    req_phase = models.CharField(max_length=100, default=1)
    req_owner = models.ForeignKey(MyUser, on_delete=models.CASCADE,related_name='req_owner', db_column='req_owner')
    req_bugimprove = models.ForeignKey(Reqbugimprove, on_delete=models.CASCADE, default=2)
    req_implementedby = models.ForeignKey(MyUser, on_delete=models.CASCADE,related_name='req_implementedby', db_column='req_implementedby', default=1)
    ...
    req_raisedon = models.DateField(default=date.today,null=True,blank=True)
