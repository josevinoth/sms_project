...
class BilingInfo(models.Model):
    ...
    bill_customer_person=models.CharField(max_length=200,default = '')
    ...
    bill_tot_crane_charges= models.FloatField(default=0.0)
    bill_tot_forklift_charges= models.FloatField(default=0.0)
    bill_tot_fumigation_charges= models.FloatField(default=0.0)
