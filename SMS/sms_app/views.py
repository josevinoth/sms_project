...
from .sub_views.salesinfo_view import sales_add,sales_list,sales_delete,sales_comments_list,sales_comments_add,sales_comments_delete,sales_search,sales_comments_search,sales_reports
