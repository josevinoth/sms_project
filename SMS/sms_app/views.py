...
from .sub_views.consignmentdetail_add_view import consignmentdetail_add,consignmentdetail_list,consignmentdetail_delete,consignmentdetail_nav,consignment_note_pdf,vehicle_allotted,consignmentdetail_cancel,get_vehicle_type,consignment_pdf_download,consignmentdetail_enquiry
...
from .sub_views.tripclosure_add_view import tripclosure_add,tripclosure_list,tripclosure_delete,tripclosure_nav,transport_calculate_trip_charges,tripclosure_enquiry,get_fastag_toll_cost_ajax,calculate_toll
...
from .sub_views.trans_invoice_view import (
    trans_invoice_add, trans_invoice_list, trans_invoice_delete,
    fetch_customer_details, trans_invoice_list_woh, trans_invoice_remove_woh,
    trans_invoice_add_woh, trans_invoice_excel, trans_invoice_tally_excel,
    trans_invoice_edit
)
...
from .sub_views.market_bill_view import market_bill_add, market_bill_list, market_bill_edit, market_bill_delete, get_vehicles_by_vendor, get_trips_by_vehicle
