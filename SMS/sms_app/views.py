...
from .sub_views.invoice_view import invoice_list,invoice_add,invoice_delete,shipper_invoice_list,shipper_invoice_goods_add,shipper_invoice_goods_remove,load_whrate_model,case_to_case_invoice_list_open,dedicated_invoice_list_open,exclusive_invoice_list_open,invoice_report,shipper_invoice_export_excel
...
from .sub_views.fuelfilling_view import fuelfilling_add,fuelfilling_list,fuelfilling_delete,load_location,fetch_bunk_details
...
from .sub_views.maintenance_view import maintenance_add,maintenance_delete,maintenance_edit,maintenance_list,fetch_vehicle_details,maintenance_pdf,manager_approval_list,manager_approve,finance_approval_list,finance_approve
