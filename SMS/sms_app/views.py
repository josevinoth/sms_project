...
from .sub_views.tripdetail_add_view import tripdetail_add,tripdetail_list,tripdetail_delete,tripdetail_nav,load_vehicle_details,trip_email,load_truck_details,fleet_management_view,tripdetail_enquiry,get_sim_tracking_data,get_customer_ref
