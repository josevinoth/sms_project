...
from .sub_views.tripdetail_add_view import tripdetail_add,tripdetail_list,tripdetail_delete,tripdetail_nav,load_vehicle_details,trip_email,load_truck_details,fleet_management_view,tripdetail_enquiry,get_sim_tracking_data,get_customer_ref,get_last_reported_km
...
from .sub_views.transport_reports_view import vehicle_log_report_view, trip_cancellation_report_view, ref_no_pending_report_view, vehicle_status_report_view, drivers_advance_report_view, invoice_pending_report_view
