...
from .sub_views.consignmentdetail_add_view import consignmentdetail_add,consignmentdetail_list,consignmentdetail_delete,consignmentdetail_nav,consignment_note_pdf,vehicle_allotted,consignmentdetail_cancel
...
from .sub_views.tripdetail_add_view import tripdetail_add,tripdetail_list,tripdetail_delete,tripdetail_nav,load_vehicle_details,trip_email,load_truck_details
...
from .sub_views.vehicle_allotment_view import vehicle_allotment_list,vehicle_allotment_add,vehicle_allotment_delete,vehicle_allotment_nav,load_vehicle_source,load_vehicle_number,load_driver_details,vehicle_requested,vehicle_type_counts
...
from .sub_views.finance_reports_view import finance_reports,businessmodel_PL,customerwise_PL,fin_profit_loss_view,expenses_report,ar_due_reports,budget_expense,budget_expense_mis,fin_mis
...
from .sub_views.part_code_view import part_code_add,part_code_list,part_code_delete,get_stock_descriptions,get_part_code,partcode_search,export_partcodes_excel
...
from .sub_views.goods_add_mbl_view import goods_mbl_list, goods_mbl_add,goods_mbl_delete,goods_mbl_update