...
from .sub_views.consignmentdetail_add_view import consignmentdetail_add,consignmentdetail_list,consignmentdetail_delete,consignmentdetail_nav,consignment_note_pdf,vehicle_allotted,consignmentdetail_cancel,get_vehicle_type,consignment_pdf_download
